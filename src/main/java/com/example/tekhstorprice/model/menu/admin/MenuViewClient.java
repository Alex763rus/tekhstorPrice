...
public class MenuViewClient extends Menu {
    ...
    private PartialBotApiMethod getHistoryActionMessage(User user, Update update, HistoryAction historyAction) {
        ...
        textManager.append(STAR).append("ID обращения: ").append(STAR).append(historyAction.getHistoryActionId()).append(NEW_LINE)
                .append(STAR).append("Обратился клиент: ").append(STAR).append(prepareShield("@" + user.getUserName())).append(NEW_LINE)
                ...
                .append(STAR).append("Товар: ").append(STAR)
                .append(historyAction.getGroupPrice()).append(" ").append(historyAction.getModelPrice()).append(NEW_LINE)
                .append(STAR).append("Цена с гарантией 2 года: ").append(STAR).append(historyAction.getPrice2year()).append(NEW_LINE)
                .append(STAR).append("Цена с гарантией 14 дней: ").append(STAR).append(historyAction.getPriceDrop()).append(NEW_LINE)
                .append(STAR).append("Оптовая цена: ").append(STAR).append(historyAction.getPriceOpt()).append(NEW_LINE);
